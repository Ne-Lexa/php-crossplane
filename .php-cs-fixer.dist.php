 ...
 * - `php7.1 '.php-cs-fixer.dist.php'`
 * - `php7.2 '.php-cs-fixer.dist.php'`
 * - `php7.3 '.php-cs-fixer.dist.php'`
 * - `php7.4 '.php-cs-fixer.dist.php'`
 * - `php8.0 '.php-cs-fixer.dist.php'`
 *
 * Use one of the following console commands to fix PHP code:
 * - `php-cs-fixer fix --config='.php-cs-fixer.dist.php'
 * - `php '.php-cs-fixer.dist.php' --force`
 * - `php7.1 '.php-cs-fixer.dist.php' --force`
 * - `php7.2 '.php-cs-fixer.dist.php' --force`
 * - `php7.3 '.php-cs-fixer.dist.php' --force`
 * - `php7.4 '.php-cs-fixer.dist.php' --force`
 * - `php8.0 '.php-cs-fixer.dist.php' --force`
 *
